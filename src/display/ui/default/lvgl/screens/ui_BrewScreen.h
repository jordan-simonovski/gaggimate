...
extern void ui_event_BrewScreen_grindSummary(lv_event_t *e);
extern lv_obj_t *ui_BrewScreen_grindSummary;
extern lv_obj_t *ui_BrewScreen_grindDoseAdjust;
extern lv_obj_t *ui_BrewScreen_grindContainer;
extern lv_obj_t *ui_BrewScreen_grindLabel;
extern lv_obj_t *ui_BrewScreen_grindLevel;
extern void ui_event_BrewScreen_downGrindButton(lv_event_t *e);
extern lv_obj_t *ui_BrewScreen_downGrindButton;
extern void ui_event_BrewScreen_upGrindButton(lv_event_t *e);
extern lv_obj_t *ui_BrewScreen_upGrindButton;
extern lv_obj_t *ui_BrewScreen_doseContainer;
extern lv_obj_t *ui_BrewScreen_doseLabel;
extern lv_obj_t *ui_BrewScreen_doseValue;
extern void ui_event_BrewScreen_downDoseButton(lv_event_t *e);
extern lv_obj_t *ui_BrewScreen_downDoseButton;
extern void ui_event_BrewScreen_upDoseButton(lv_event_t *e);
extern lv_obj_t *ui_BrewScreen_upDoseButton;
extern lv_obj_t *ui_BrewScreen_ratioContainer;
extern lv_obj_t *ui_BrewScreen_ratioValue;
