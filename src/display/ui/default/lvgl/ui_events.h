...
void onBrewGrindLevelLower(lv_event_t *e);
void onBrewGrindLevelRaise(lv_event_t *e);
void onBrewDoseLower(lv_event_t *e);
void onBrewDoseRaise(lv_event_t *e);
void onBrewGrindDoseOpen(lv_event_t *e);
